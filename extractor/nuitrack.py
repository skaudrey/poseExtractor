...
@file   : nuitrack.py
@ide    : PyCharm
@time   : 2021-05-02 16:12:22
@descrip: https://github.com/silasalves/pynuitrack
There are conflicts between cubemos sdk and nuitrack sdk. If one wants the nuitrack works, delete the cubemos variable
in environment variable and then restart PC.
'''
