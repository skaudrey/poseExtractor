...
def gendata(data_path,
    ...
    for filename in os.listdir(data_path):
        ...
        if benchmark == 'xview': # cross view
            istraining = (camera_id in training_cameras)
        elif benchmark == 'xsub': # cross subject
    ...
    for i, s in enumerate(sample_name):
        ...
        clip_fcount[s] = data.shape[1]

    end_toolbar()
    with open('{}/{}_fcount.pkl'.format(out_path, part), 'wb') as f:
        pickle.dump(clip_fcount, f)
